...
const (
	ReportService_GetReport_FullMethodName = "/ReportService/GetReport"
)
...
func (c *reportServiceClient) GetReport(ctx context.Context, in *ReportRequest, opts ...grpc.CallOption) (*ReportResponse, error) {
...
func (UnimplementedReportServiceServer) GetReport(context.Context, *ReportRequest) (*ReportResponse, error) {
...
func _ReportService_GetReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GetReport(ctx, req.(*ReportRequest))
	}
...
const (
	Controller_GetReport_FullMethodName = "/Controller/GetReport"
)
...
type ControllerClient interface {
	GetReport(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReportResponse, error)
}
...
func (c *controllerClient) GetReport(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReportResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReportResponse)
	err := c.cc.Invoke(ctx, Controller_GetReport_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControllerServer interface {
	GetReport(context.Context, *emptypb.Empty) (*ReportResponse, error)
...
func (UnimplementedControllerServer) GetReport(context.Context, *emptypb.Empty) (*ReportResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReport not implemented")
}
...
func _Controller_GetReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Controller_GetReport_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServer).GetReport(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
