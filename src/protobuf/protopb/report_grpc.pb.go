...
func (c *reportServiceClient) GetReport(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ReportResponse, error) {
...
func (UnimplementedReportServiceServer) GetReport(context.Context, *emptypb.Empty) (*ReportResponse, error) {
...
func _ReportService_GetReport_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GetReport(ctx, req.(*emptypb.Empty))
	}
