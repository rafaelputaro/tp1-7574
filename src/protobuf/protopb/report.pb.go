...
func (x *ReportRequest) GetClientId() string {
...
const file_report_proto_rawDesc = "" +
	...
	"\x05score\x18\x02 \x02(\x02R\x05score\"+\n" +
	"\rReportRequest\x12\x1a\n" +
	"\bclientId\x18\x01 \x02(\tR\bclientId2=\n" +
	"\rReportService\x12,\n" +
	"\tGetReport\x12\x0e.ReportRequest\x1a\x0f.ReportResponse2B\n" +
	"\n" +
	"Controller\x124\n" +
...
var file_report_proto_goTypes = []any{
	...
	(*ReportRequest)(nil),  // 11: ReportRequest
...
var file_report_proto_depIdxs = []int32{
	...
	11, // 12: ReportService.GetReport:input_type -> ReportRequest
	12, // 13: Controller.GetReport:input_type -> google.protobuf.Empty
	0,  // 14: ReportService.GetReport:output_type -> ReportResponse
	0,  // 15: Controller.GetReport:output_type -> ReportResponse
